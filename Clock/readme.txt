========================================================================
       MICROSOFT FOUNDATION CLASS ライブラリ : Clock
========================================================================


AppWizard が生成した Clock には、Microsoft Foundation Class の基本的な
使い方が示されています。アプリケーション作成のひな型としてお使いください。

このファイルには Clock を構成している各ファイルの概要説明が含まれています。
...
Clock.h
    ...
    みます） をインクルードし、また CClockApp アプリケーションクラスを宣
    言します。

Clock.cpp
    このファイルは CClockApp アプリケーションクラスを含むアプリケーション
    の中心となるソースファイルです。
...
res\Clock.ico
    ...
    ルです。このアイコンはリソース ファイル Clock.rc によってインクルード
    されます。
...
ClockDlg.h, ClockDlg.cpp - ダイアログ
    これらのファイルは CClockDlg クラスを含みます。このクラスは 
    アプリケーションのメイン ダイアログの動作を定義します。ダイアログ
    テンプレートは Microsoft Visual C++ で編集可能な Clock.rc に含
    まれます。
...
StdAfx.h, StdAfx.cpp
    これらのファイルはプリコンパイル済ヘッダー ファイル (PCH) Clock.pch 
